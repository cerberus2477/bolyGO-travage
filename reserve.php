                    ...
                    <section>
                        <form onsubmit="event.preventDefault(); Folytat(<?=$orderNum?>);">
                            ...
                            <div class="form-group">
                                ...
                                <input onchange='kiszamolAr(<?=$data["csomagar"]?>, <?=$elem["fo"]?>, <?=$elem["id"]?>)' type="date" id="<?=$elem["id"]?>_kezd" min=<?=$data["kezdido"]?> max="<?=$data["vegido"]?>" required>
                            </div>
                            <div class="form-group">
                                <label for="<?=$elem["id"]?>_vege">Adja meg a foglalás végének dátumát:</label>
                                <input onchange='kiszamolAr(<?=$data["csomagar"]?>, <?=$elem["fo"]?>, <?=$elem["id"]?>)' type="date" id="<?=$elem["id"]?>_vege" min=<?=$data["kezdido"]?> max="<?=$data["vegido"]?>" required>
                            </div>
                            <div class="form-group">
                            ...
                            <?php for ($i = 1; $i <= $elem["fo"]; $i++):?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input required type="text" id="<?=$elem["id"]?>_utas<?=$i?>_nev">
                                </div>
                                <div class="form-group">
                                    <label for="<?=$elem["id"]?>_utas<?=$i?>_lakcim">Lakcím:</label>
                                    <input required type="text" id="<?=$elem["id"]?>_utas<?=$i?>_lakcim">
                                </div>
                                <div class="form-group">
                                    <label for="name">Születési dátum:</label>
                                    <input required type="date" id="<?=$elem["id"]?>_utas<?=$i?>_szul">
                                </div>
                                <div class="form-group">
                                    <label for="<?=$elem["id"]?>_utas<?=$i?>_nem">Nem:</label>
                                    <input required type="text" id="<?=$elem["id"]?>_utas<?=$i?>_nem">
                                </div>
                                <div class="form-group">
                                    <label for="<?=$elem["id"]?>_utas<?=$i?>_nem">Telefon:</label>
                                    <input required type="tel" id="<?=$elem["id"]?>_utas<?=$i?>_tel">
                                </div>
                                <div class="form-group">
                                    <label for="<?=$elem["id"]?>_utas<?=$i?>_nem">E-mail:</label>
                                    <input required type="email" id="<?=$elem["id"]?>_utas<?=$i?>_email">
                                </div>
                            <?php endfor;?>
                        </form>
